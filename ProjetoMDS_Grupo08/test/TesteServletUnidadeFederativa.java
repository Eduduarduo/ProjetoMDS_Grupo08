...
public class TesteServletUnidadeFederativa {
	...
	public void testBuscaUnidadeFederartiva() throws ServletException, IOException, SQLException{
		...
		servletUF.buscaUnidadeFederativa(ano1,uf, unidadeFederativaDao,exception, request, response);
	}
	@Test 
	public void testBuscaUnidadeFederartiva1() throws ServletException, IOException, SQLException{
		servletUF.buscaUnidadeFederativa(ano2, uf, unidadeFederativaDao, exception, request, response);
	}
	
	@Test 
	public void testBuscaUnidadeFederartivaAnoFalse() throws ServletException, IOException, SQLException{
		servletUF.buscaUnidadeFederativa(anofalse, uf, unidadeFederativaDao, exception, request, response);
		
	}
	@Test 
	public void testBuscaUnidadeFederartivaUFFalse() throws ServletException, IOException, SQLException{
		
		servletUF.buscaUnidadeFederativa(ano1, ufFalse, unidadeFederativaDao,exception, request, response);
	}
	@Test 
	public void testBuscaUnidadeFederartivaAmbosFalse() throws ServletException, IOException, SQLException{
		servletUF.buscaUnidadeFederativa(anofalse, ufFalse, unidadeFederativaDao,exception, request, response);
	}
	...
	public void testComparacaoPorUF() throws ServletException, IOException, SQLException{
			servletUF.ComparacaoPorUF(ano1, uf, uf2, unidadeFederativaDao, request, response);
	}
	@Test
	public void testComparacaoPorUFAno1False() throws ServletException, IOException, SQLException{
		servletUF.ComparacaoPorUF(anofalse, uf , uf2, unidadeFederativaDao, request,response);
	}
	@Test
	public void testComparacaoPorUFAnoUf1False() throws ServletException, IOException, SQLException{
		servletUF.ComparacaoPorUF(anofalse, ufFalse , uf2, unidadeFederativaDao, request,response);
	}
	@Test
	public void testComparacaoPorUAllFalse() throws ServletException, IOException, SQLException{
		servletUF.ComparacaoPorUF(anofalse, ufFalse , ufFalse, unidadeFederativaDao, request,response);
	}
	...
	public void testComparacaoPorUuf1False() throws ServletException, IOException, SQLException{
		servletUF.ComparacaoPorUF(ano1, ufFalse , uf2, unidadeFederativaDao, request,response);
	}
	@Test
	public void testComparacaoPorUuf2False() throws ServletException, IOException, SQLException{
		servletUF.ComparacaoPorUF(ano1, uf , ufFalse, unidadeFederativaDao, request,response);
	}	

	@Test
	public void testgetAnosComparacaoUnidadeFederativa() throws ServletException, IOException, SQLException{
		servletUF.getAnosComparacaoUnidadeFederativa(ano1,request);
		
	}
	@Test
	public void testgetAnosComparacaoUnidadeFederativaanoFalse() throws ServletException, IOException, SQLException{
		servletUF.getAnosComparacaoUnidadeFederativa(anofalse,request);
